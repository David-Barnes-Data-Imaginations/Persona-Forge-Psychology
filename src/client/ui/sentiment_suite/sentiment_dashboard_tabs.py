...
def build_dashboard_tabbed(model_name: str, data, kind: str = "utterance"):
    ...
    if kind == "utterance" and "speaker" in df.columns:
        ...
        therapist_figs = create_sentiment_dashboard_plotly(therapist_df, show_text=False) # <----- review this once venv sorted.
        client_figs = create_sentiment_dashboard_plotly(client_df, show_text=False) # <----- review this once venv sorted.
        ...
        figs = create_sentiment_dashboard_plotly(df, show_text=False)  # <----- review this once venv sorted.
